                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="/admin/tracks/{{ $track->id }}/courses/create" class="btn btn-sm btn-primary">Add course</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card" style="width: 17rem;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/admin/courses/{{ $course->id }}" method="POST">
                                    ...
                                    <a href="/admin/courses/{{ $course->id }}" class="btn btn-primary btn-sm">Show</a>
