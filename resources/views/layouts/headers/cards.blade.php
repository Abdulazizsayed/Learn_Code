                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">
                                        <a href="/admin/tracks">{{ App\Track::all()->count() }}</a>
                                    </span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">
                                        <a href="/admin/courses">{{ App\Course::all()->count() }}</a>
                                    </span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">
                                        <a href="/admin/users">{{ App\User::where('admin', 0)->count() }}</a>
                                    </span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">
                                        <a href="/admin/quizzes">{{ App\Quiz::all()->count() }}</a>
                                    </span>
                                </div>
                                <div class="col-auto">
